...
args.dataPath = f"{args.data_dir}/{args.suffix}/merged_situData_G{args.testGroup}_years_{args.suffix}.csv"
args.saveDir = f"./GBM_reImplement/{args.suffix}_{args.kind}/{args.testGroup}"
if args.appendix:
    args.saveDir = (
        f"./GBM_reImplement/{args.suffix}_{args.kind}_{args.appendix}/{args.testGroup}"
    )
args.CSV_savePath = f"{args.saveDir}/situ_GBM_G{args.testGroup}_{args.suffix}.csv"
...
def trainGBM_CV_groupYears(bar=10.0):
    ...
    GBM_save_path = args.CSV_savePath
...
"""
python model_GBM_pretrainMergedData.py --suffix preTrain_shapeNoDrop --appendix reImplement --testGroup 0
"""
