...
class ResNetLayer(nn.Module):
    ...
    def __init__(
        self, in_channels, out_channels, n=1, block=ResNetBasicBlock, *args, **kwargs
    ):
        super().__init__()
...
class ResnetDecoder(nn.Module):
    ...
    def __init__(self, in_features, n_hidden, n_classes):
        ...
        self.decoder = nn.Sequential(
            nn.Linear(in_features, n_hidden), nn.Linear(n_hidden, n_classes)
        )
...
def resnet18(in_channels, n_hidden, n_classes, block=ResNetBasicBlock, *args, **kwargs):
    return ResNet(
        in_channels,
        n_hidden,
        n_classes,
...
def resnet34(in_channels, n_hidden, n_classes, block=ResNetBasicBlock, *args, **kwargs):
    return ResNet(
        in_channels,
        n_hidden,
        n_classes,
...
def resnet50(
    in_channels, n_hidden, n_classes, block=ResNetBottleNeckBlock, *args, **kwargs
):
    return ResNet(
        in_channels,
        n_hidden,
