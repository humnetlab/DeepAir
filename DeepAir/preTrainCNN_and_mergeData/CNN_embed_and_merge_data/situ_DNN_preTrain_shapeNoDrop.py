...
class situNet_ElevaLand(nn.Module):
    ...
    def forward(self, attr, config):
        ...
        # basemap_vec = self.basemap_embedding(attr["BaseMap"])
        ...
        # lon_vec = attr["Lon"].unsqueeze(1)
        # lat_vec = attr["Lat"].unsqueeze(1)
        ...
        # map_vector = self.map_embedding(img["BaseMap"])  # [bs, 50]
    ...
    def eval_on_batch(self, attr, config):
        ...
        # loss_ = torch.nn.SmoothL1Loss()  # torch.nn.MSELoss()  #
